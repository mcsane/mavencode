...
import task7_3.application.CurrencyConverterController;
...
public class CurrencyConverterView extends Application {
    ...
    public void start(Stage stage) {
        ...
        choiceBox1.getItems().addAll("USD", "EUR", "GBP", "JPY", "AUD", "CAD", "CHF", "CNY");
        choiceBox2.getItems().addAll("USD", "EUR", "GBP", "JPY", "AUD", "CAD", "CHF", "CNY");
